...
var _visNetworkAdvanced = require("vis-network-advanced");
...
var Graph = function (_Component) {
  ...
  _createClass(Graph, [{
    ...
    value: function updateGraph() {
      ...
      this.Network = new _visNetworkAdvanced.Network(this.container.current, Object.assign({}, this.props.graph, {
        edges: this.edges,
        nodes: this.nodes
      }), options);
